...
export default {
  ...
  methods: {
    ...
    async analyzeGenre() {
      ...
      const predictedIndex = prediction.argMax(-1).dataSync()[0]; // Get the index of the highest probability genre
      this.genre = this.genres[predictedIndex]; // Map the index to the corresponding genre name
